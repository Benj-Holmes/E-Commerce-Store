...
export const createOrder = createAsyncThunk(
    ...
    async () => {
        const response = await axios.post(`${process.env.API_URL}/api/orders`, {}, {withCredentials: true});
...
export const getMembersOrders = createAsyncThunk(
    ...
    async () => {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/orders`, {withCredentials: true});
        return response.data;
    }
)
...
export const getOrderItems = createAsyncThunk(
    ...
    async (order_id) => {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/orders/${order_id}`);
        return response.data;
    }
