...
export const getCartItems = createAsyncThunk(
    'cart/getCartItems',
    async() => {
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/cart/items`, {withCredentials: true});
        return response.data;
    }
)
...
export const deleteItemFromCart = createAsyncThunk(
    ...
    async(prodId) => {
        const response = await axios.delete(`${process.env.REACT_APP_API_URL}/api/cart/${prodId}`, 
        {withCredentials: true});
        return response.data;
    }
)
...
export const setCartToInactive = createAsyncThunk(
    ...
    async() => {
        const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/cart`, {}, {withCredentials: true});
        return response.data;
    }
)
...
export const updateCartQuantity = createAsyncThunk(
    ...
    async (data) => {
        console.log(data);
        const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/cart/increment`, {
